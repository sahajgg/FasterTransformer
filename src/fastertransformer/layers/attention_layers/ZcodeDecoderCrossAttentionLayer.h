...
template<typename T>
class ZcodeDecoderCrossAttentionLayer: public BaseAttentionLayer<T> {
private:
    // metadata
...
protected:
    ...
    T* q_buf_step0_       = nullptr;
    T* q_buf_2_step0_     = nullptr;
    T* qk_buf_step0_      = nullptr;
    T* context_buf_step0_ = nullptr;
    T* context_buf_2_step0_ = nullptr;
    T* attention_mask_step0_    = nullptr;
    T* mem_cache_buf_2_step0_     = nullptr;
...
public:
    ZcodeDecoderCrossAttentionLayer(size_t           max_batch_size,
                               size_t           head_num,
    ...
    ZcodeDecoderCrossAttentionLayer(ZcodeDecoderCrossAttentionLayer<T> const& attention_layer);

    ~ZcodeDecoderCrossAttentionLayer();
