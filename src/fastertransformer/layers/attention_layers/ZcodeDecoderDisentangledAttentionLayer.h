...
template<typename T>
class ZcodeDecoderDisentangledAttentionLayer: public BaseAttentionLayer<T> {
private:
    // metadata
    size_t head_num_;
    ...
    void allocateBuffer(size_t batch_size, size_t seq_len, size_t new_cache_seq_len);
...
public:
    ...
    ZcodeDecoderDisentangledAttentionLayer(ZcodeDecoderDisentangledAttentionLayer<T> const& attention_layer);

    ~ZcodeDecoderDisentangledAttentionLayer();
