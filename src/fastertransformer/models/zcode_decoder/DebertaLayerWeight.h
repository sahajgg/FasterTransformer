...
template<typename T>
struct ZcodeDecoderLayerWeight {

    ZcodeDecoderLayerWeight() = default;
    ZcodeDecoderLayerWeight(const size_t hidden_units,
                       const size_t inter_size,
                       const size_t tensor_para_size,
                       const size_t tensor_para_rank);
    ZcodeDecoderLayerWeight(const int hidden_units, const int inter_size): ZcodeDecoderLayerWeight(hidden_units, inter_size, 1, 0)
    {
    }
    ~ZcodeDecoderLayerWeight();
    ZcodeDecoderLayerWeight(const ZcodeDecoderLayerWeight& other);
    ZcodeDecoderLayerWeight& operator=(const ZcodeDecoderLayerWeight& other);
