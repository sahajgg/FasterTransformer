...
template<typename T>
ZcodeEncoderLayerWeight<T>::ZcodeEncoderLayerWeight(const size_t hidden_units,
...
template<typename T>
ZcodeEncoderLayerWeight<T>::~ZcodeEncoderLayerWeight()
{
...
template<typename T>
ZcodeEncoderLayerWeight<T>::ZcodeEncoderLayerWeight(const ZcodeEncoderLayerWeight& other):
    ZcodeEncoderLayerWeight(other.hidden_units_, other.inter_size_, other.tensor_para_size_, other.tensor_para_rank_)
{
    FT_LOG_DEBUG(__PRETTY_FUNCTION__);
...
template<typename T>
ZcodeEncoderLayerWeight<T>& ZcodeEncoderLayerWeight<T>::operator=(const ZcodeEncoderLayerWeight& other)
{
    FT_LOG_DEBUG(__PRETTY_FUNCTION__);
...
template<typename T>
void ZcodeEncoderLayerWeight<T>::compress_weights(cublasMMWrapper& cublas_wrapper, int hidden_dim)
{
...
template<typename T>
void ZcodeEncoderLayerWeight<T>::loadModel(std::string dir_path, FtCudaDataType model_file_type)
{
    FT_LOG_DEBUG(__PRETTY_FUNCTION__);
    for (auto it = weights_ptr_.begin(); it != weights_ptr_.end(); ++it) {
...
template<typename T>
void ZcodeEncoderLayerWeight<T>::setWeightPtr()
{
    FT_LOG_DEBUG(__PRETTY_FUNCTION__);
...
template struct ZcodeEncoderLayerWeight<float>;
template struct ZcodeEncoderLayerWeight<half>;
#ifdef ENABLE_BF16
template struct ZcodeEncoderLayerWeight<__nv_bfloat16>;
#endif
