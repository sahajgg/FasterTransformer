...
class IFZcodeEncoder {
public:
    virtual ~IFZcodeEncoder() {}
...
template<typename T>
class FTZcodeEncoder: public IFZcodeEncoder {
public:
    FTZcodeEncoder(size_t                         head_num,
              size_t                         head_size,
                 ...
                 bool        removing_padding) override
    {
        ...
        ft::ZcodeEncoder<T>* deberta = new ft::ZcodeEncoder<T>(batch_size,
                                                     seq_len,
                                                     _head_num,
                                                     _head_size,
...
private:
    ...
    ft::ZcodeEncoderWeight<T> deberta_weights;
};

class FasterTransformerZcodeEncoder: public th::jit::CustomClassHolder {
public:
    FasterTransformerZcodeEncoder(th::Tensor q_kernel,
                             th::Tensor q_bias,
                             th::Tensor k_kernel,
                             th::Tensor k_bias,
                             th::Tensor v_kernel,
